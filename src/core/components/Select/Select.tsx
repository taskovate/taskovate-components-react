...
const Styled = styled<any>(ReactSelect)`
  ...
  .react-select {
    ...
    &__menu {
      ...
      background-color: ${({ theme: { inputStyles } }) => inputStyles.menuBackground['body'].default()};
      ...
      &--close {
        animation: fadeOut ${animation.slow()};
      }
    }
    &__menu-list {
    ...
    &__option {
      ...
      color: ${({ theme: { inputStyles } }) => inputStyles.color['body'].default()};
      &:hover {
        background-color: ${({ theme: { inputStyles } }) => inputStyles.menuBackground['body'].hover()};
      }
      &:active {
        background-color: ${({ theme: { inputStyles } }) => inputStyles.menuBackground['body'].active()};
      }
      &--is-selected {
        background-color: ${({ theme: { inputStyles } }) => inputStyles.menuBackground['body'].selected()} !important;
      }
    }
    &__single-value {
      color: ${({ theme: { inputStyles } }) => inputStyles.color['body'].default()};
